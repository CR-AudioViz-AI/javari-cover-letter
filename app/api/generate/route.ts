...
// Javari Cover Letter — AI Generation API
...
const SYSTEM_PROMPT = `You are an expert cover letter writer for CR AudioViz AI. Create compelling, personalized cover letters that open doors. Match tone to industry. Show personality while remaining professional. Always include specific examples.`
